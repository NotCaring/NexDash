...
<head>
    <meta charset="utf-8
    <link rel='shortcut icon' type='image/x-icon' href='{$base_url}assets/images/icons/icon.ico' />
    ...
    <div class="app-container app-theme-white body-tabs-shadow fixed-sidebar fixed-header">
        <div class="app-header header-shadow bg-slick-carbon header-text-light">
            <div class="app-header__logo">
                <div class="logo-src"><center><h6><b>{$title}</b></h6></center></div>
			...
			{if $auth.logged_in}
				...
				<div><b>Creditos:</b> {if $auth.credits > 50}<b class="credits-positive">{$auth.credits}</b>{else}<b class="credits-negative">{$auth.credits}</b>{/if}</div>	
                            ...
                            <div class="widget-content-wrapper">
                                <div class="widget-content-left">
                                    <div class="btn-group">
                                        ...
                                        <div tabindex="-1" role="menu" aria-hidden="true" class="dropdown-menu dropdown-menu-right">
                                            ...
                                            <button type="button" onclick="window.location.href='{$base_url}index.php?act=changepass'" tabindex="0" class="dropdown-item"><i class="fas fa-key"></i>&nbsp;&nbsp;&nbsp;&nbsp;Mudar Senha</button>
                                            <div tabindex="-1" class="dropdown-divider"></div>
                                            <button type="button" onclick="window.location.href='{$base_url}index.php?act=logout'" tabindex="0" class="dropdown-item"><i class="fas fa-sign-out-alt"></i>&nbsp;&nbsp;&nbsp;&nbsp;Logout</button>
                                        </div>
                                    </div>
                                </div>
                                <div class="widget-content-left  ml-3 header-user-info">
									<div class="widget-heading">
											...
											<span style="text-transform:capitalize">{$auth.login}</span>
		...
		<div class="app-main">
		{include file='file:sidebars/menu.tpl'}