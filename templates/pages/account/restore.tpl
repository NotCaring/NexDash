    ...
    <div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100 p-t-50 p-b-90">
				...
				<form method="POST" action="{$base_url}index.php?act=restore" class="login100-form validate-form flex-sb flex-w">
					...
					<div class="wrap-input100 validate-input m-b-16" data-validate = "Username is required">
						<input class="input100" type="text" placeholder="Usuário ou endereço de e-mail" id="name" name="name" value="{$login}">
					...
					<div class="flex-sb-m w-full p-t-3 p-b-24">
						<div class="contact100-form-checkbox">
							<a href="{$base_url}index.php?act=register" class="btn btn-success login100-form-btn">
								 REGISTRAR
							</a>
						</div>
						<div>
							<a href="{$base_url}index.php?act=login" class="btn btn-primary login100-form-btn" >
								 FAZER LOGIN
							</a>
						</div>
					</div>
