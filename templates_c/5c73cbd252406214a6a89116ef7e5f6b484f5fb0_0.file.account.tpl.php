<?php
/* Smarty version 3.1.38, created on 2023-05-22 20:37:24
  from '/home/u695161280/domains/cubanoficial.shop/public_html/templates/pages/account/account.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.38',
  'unifunc' => 'content_646bfcb4e4c928_16437466',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '5c73cbd252406214a6a89116ef7e5f6b484f5fb0' => 
    array (
      0 => '/home/u695161280/domains/cubanoficial.shop/public_html/templates/pages/account/account.tpl',
      1 => 1684790422,
      2 => 'file',
    ),
  ),
...
function content_646bfcb4e4c928_16437466 (Smarty_Internal_Template $_smarty_tpl) {
...
?>
									<tr>
										...
										<td><?php if ($_smarty_tpl->tpl_vars['info']->value['type'] == 'x64') {?><div class="badge badge-dark">INJETOR MOBILE</div><?php } elseif ($_smarty_tpl->tpl_vars['info']->value['type'] == 'x86') {?><div class="badge badge-pill badge-danger">INJETOR EMULADOR</div><?php } elseif ($_smarty_tpl->tpl_vars['info']->value['type'] == 'injetor') {?><div class="badge badge-dark">INJETOR MOBILE</div><?php } elseif ($_smarty_tpl->tpl_vars['info']->value['type'] == 'script') {?><div class="badge badge-pill badge-secondary">SCRIPT</div><?php } elseif ($_smarty_tpl->tpl_vars['info']->value['type'] == 'regedit') {?><div class="badge badge-pill badge-info">REGEDIT</div><?php } else { ?><div class="badge badge-pill badge-dark">MACRO</div><?php }?></td>
										<td>
...
?>
									<tr>
										...
										<td><?php if ($_smarty_tpl->tpl_vars['last']->value['modo'] == 'injetor') {?><div class="badge badge-dark">INJETOR MOBILE</div><?php } elseif ($_smarty_tpl->tpl_vars['last']->value['modo'] == 'x86') {?><div class="badge badge-pill badge-danger">INJETOR EMULADOR</div><?php } elseif ($_smarty_tpl->tpl_vars['last']->value['modo'] == 'script') {?><div class="badge badge-pill badge-secondary">SCRIPT</div><?php } elseif ($_smarty_tpl->tpl_vars['last']->value['modo'] == 'regedit') {?><div class="badge badge-pill badge-info">REGEDIT</div><?php } else { ?><div class="badge badge-pill badge-dark">MACRO</div><?php }?></td>
									</tr>
								<?php
}
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
