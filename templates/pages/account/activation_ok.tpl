		...
		<div class="container-login100">
			<div class="wrap-login100 p-t-50 p-b-90">
				...
				<div class="alert alert-success">
					Sua conta <strong>{$login}</strong> foi ativada com sucesso! Agora você pode fazer <strong><a href="{$base_url}index.php?act=login&login={$login}">login</a></strong>.
					<meta http-equiv="refresh" content="3; URL='{$base_url}index.php?act=login&login={$login}'"/>
				</div>
			</div>
		</div>
	</div>
