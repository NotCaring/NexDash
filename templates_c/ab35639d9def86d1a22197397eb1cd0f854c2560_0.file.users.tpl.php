<?php
/* Smarty version 3.1.38, created on 2025-10-12 21:41:32
  from '/home/u999974013/domains/sftzone.site/public_html/4m/templates/pages/account/users.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.38',
  'unifunc' => 'content_68ec4abcda0969_03219342',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'ab35639d9def86d1a22197397eb1cd0f854c2560' => 
    array (
      0 => '/home/u999974013/domains/sftzone.site/public_html/4m/templates/pages/account/users.tpl',
      1 => 1760315808,
      2 => 'file',
    ),
  ),
...
function content_68ec4abcda0969_03219342 (Smarty_Internal_Template $_smarty_tpl) {
...
?act=users&pauseall=all" class="btn btn-warning" onClick="return confirm(\'Você deseja pausar todas as Keys?\');"><i class="fa fa-pause mr-1"></i> Pausar todas as Keys</a>
					<a href="<?php echo $_smarty_tpl->tpl_vars['script_url']->value;?>
?act=users&unpauseall=all" class="btn btn-success" onClick="return confirm(\'Você deseja despausar todas as Keys?\');"><i class="fa fa-play mr-1"></i> Despausar todas as Keys</a>
					<a href="<?php echo $_smarty_tpl->tpl_vars['script_url']->value;?>
...
if ($_smarty_tpl->tpl_vars['record']->value['pause'] == 0) {?><div class='badge badge-pill badge-secondary'>Em uso</div><?php } else { ?><div class='badge badge-pill badge-warning'>Pausado</div><?php }
							...
							<td><?php if ($_smarty_tpl->tpl_vars['record']->value['mode'] == 'injetor') {?><div class="badge badge-dark">INJETOR MOBILE</div><?php } elseif ($_smarty_tpl->tpl_vars['record']->value['mode'] == 'x86') {?><div class="badge badge-pill badge-danger">INJETOR EMULADOR</div><?php } elseif ($_smarty_tpl->tpl_vars['record']->value['mode'] == 'injetor') {?><div class="badge badge-dark">INJETOR MOBILE</div><?php } elseif ($_smarty_tpl->tpl_vars['record']->value['mode'] == 'script') {?><div class="badge badge-pill badge-secondary">SCRIPT</div><?php } elseif ($_smarty_tpl->tpl_vars['record']->value['mode'] == 'regedit') {?><div class="badge badge-pill badge-info">REGEDIT</div><?php } else { ?><div class="badge badge-pill badge-dark">MACRO</div><?php }?></td>
