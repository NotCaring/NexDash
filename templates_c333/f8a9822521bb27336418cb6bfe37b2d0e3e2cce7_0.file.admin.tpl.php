<?php
/* Smarty version 3.1.38, created on 2022-01-24 02:19:37
  from '/home/u129344762/domains/ninjacheat.xyz/public_html/CHEAT/Ninja/templates/pages/admin/admin.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.38',
  'unifunc' => 'content_61ee36e9c97459_96244485',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'f8a9822521bb27336418cb6bfe37b2d0e3e2cce7' => 
    array (
      0 => '/home/u129344762/domains/ninjacheat.xyz/public_html/CHEAT/Ninja/templates/pages/admin/admin.tpl',
      1 => 1643001576,
      2 => 'file',
    ),
  ),
...
function content_61ee36e9c97459_96244485 (Smarty_Internal_Template $_smarty_tpl) {
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
	...
	<div class="row">
		<div class="col-md-12">
			<div class="main-card mb-3 card">
				<div class="card-header"> Pedidos de contas
					<hr>
					<small>Pedidos de recuperação de conta</small>
				</div>
				<div class="card-body p-0">
					<?php if (count($_smarty_tpl->tpl_vars['restore_accounts']->value) > 0) {?>
						...
						<table class="table table-hover table-fixed">
							...
							<tbody>
							<?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['restore_accounts']->value, 'account');
...
?>
							<tr>
								...
								<td><?php echo $_smarty_tpl->tpl_vars['account']->value['time'];?>
</td>
...
index.php?act=admin" method="POST">
					...
					<div class="d-block text-right card-footer">
						<button type="submit" name="Submit" class="btn btn-primary btn-lg">ADICIONAR DIAS</button>
...
" class="psctcircle" style="width: 20px;">&nbsp;<?php echo $_smarty_tpl->tpl_vars['cheat']->value['gamename'];?>
								...
								<td><?php if ($_smarty_tpl->tpl_vars['cheat']->value['mode'] == 'mod') {?><div class="badge badge-pill badge-warning">MOD APK</div><?php } elseif ($_smarty_tpl->tpl_vars['cheat']->value['mode'] == 'script') {?><div class="badge badge-pill badge-secondary">SCRIPT</div><?php } elseif ($_smarty_tpl->tpl_vars['cheat']->value['mode'] == 'injetor') {?><div class="badge badge-pill badge-info">INJETOR</div><?php } else { ?><div class="badge badge-pill badge-dark">MACRO</div><?php }?></td>
